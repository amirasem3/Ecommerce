...
public interface IManufacturerService
{
    ...
    public Task<ManufacturerDto> GetManufacturerByAddressAsync(string address);
    public Task<ManufacturerDto> GetManufacturerByEmailAsync(string email);
    public Task<ManufacturerDto> GetManufacturerByPhoneNumberAsync(string phoneNumber);
